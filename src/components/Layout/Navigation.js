...
export const Navigation = ({ isOpen, toggle }) => {
    ...
    return (
        <div style={{ width: (isOpen ? '100%' : '0') }} id="mySidenav" className="sidenav my-menu" >
            ...
            <a className="nav-logo pointer" ><Link href="/"><img className="float-left" src="img/logo.png" alt="logo" /></Link></a>
            <a className="closebtn pointer" onClick={toggle}>×</a>
            <div className="my-menu-div">
                <div className="row justify-content-between align-items-center">
                    <div className="col-lg-4 col-md-6">
                        <ul>
                            <li> <Link href="/"><a className="nav-link" ><span>01</span> Home</a></Link></li>
                            <li> <Link href="/about"><a className="nav-link" ><span>02</span> About</a></Link></li>
                            <li> <Link href="/service"><a className="nav-link" ><span>03</span> Services</a></Link></li>
                            <li> <a className="nav-link" target="_blank" href="https://calendly.com/jaskhatri/15min"><span>04</span> Consultation</a></li>
                            <li> <Link href="/contact-us"><a className="nav-link" ><span>05</span> Contact</a></Link></li>
                        </ul>
                    </div>
                    {!isMobile && (
