        ...
        <div className="container-fluid">
          ...
          <div className="row justify-content-center">
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
              <img
                className="img-fluid customor-logo"
                src="img/Bostellogolg.png"
              />
            </div>
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
            ...
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
              <img
                className="img-fluid customor-logo"
                src="img/chartipedia_logo_light.f47df378.svg"
              />
            </div>
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
            ...
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
              <img
                className="img-fluid customor-logo"
                src="img\kb_logo_white.svg"
              />
            </div>
            <div className="col-md-4 col-sm-6 col-6 p-3 mt-4">
              <img className="img-fluid customor-logo" src="img\logo (1).png" />
            </div>
